...
str_instance = 'PYForecastSellInAndOutColorNumber'
...
def step01_preprocess_rts_eos(
    ...
    fn_convert_type(rts, 'RTS_' , 'category')
    fn_convert_type(rts, 'EOS_' , 'category')
...
if __name__ == '__main__':
    ...
    try:
        ...
        if is_local:
            ...
            output_folder_name = f'PYForecastSellInAndOutColorNumber'
            # # ME
