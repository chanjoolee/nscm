...
str_instance = 'PYDPMakeActualAndInventoryForecastLevel'
...
########################################################################################################################
# Step 07 :  Input × Output Merge → 최종 테이블 생성
########################################################################################################################
@_decoration_
...
if __name__ == '__main__':
    ...
    try:
        ...
        if is_local:
            ...
            output_folder_name = 'PYDPMakeActualAndInventoryForecastLevel_0910_step08_FastGroupby'
            # ------
...
################################################################################################################
        ...
        dict_log = {
            'p_step_no'  : 70,
            'p_step_desc': 'Step 07) Input·Output Merge',
            'p_df_name'  : None
        }
        ict_final = fn_step07_merge_input_output(
            input_dataframes,     # step-00 에서 이미 채워 둔 global dict
            dict_step06,          # step-06(Version 추가) 의 반환값
            **dict_log
        )

        # 결과 확인용 로그
        for _name, _df in ict_final.items():
            fn_log_dataframe(_df, f'step_07_{_name}')
        ...
        # 최종 output
        ########################################################################################################################
        df_output_Sell_In_FCST_GI_AP1		= ict_final[STR_DF_OUT_SI_FCST_GI_AP1  ]			
        df_output_Sell_In_FCST_GI_AP2       = ict_final[STR_DF_OUT_SI_FCST_GI_AP2  ]
        df_output_Sell_In_FCST_GI_GC        = ict_final[STR_DF_OUT_SI_FCST_GI_GC   ]
        df_output_Sell_In_FCST_GI_Local     = ict_final[STR_DF_OUT_SI_FCST_GI_LOCAL]
        df_output_Sell_In_FCST_BL_AP1       = ict_final[STR_DF_OUT_SI_FCST_BL_AP1  ]
        df_output_Sell_In_FCST_BL_AP2       = ict_final[STR_DF_OUT_SI_FCST_BL_AP2  ]
        df_output_Sell_In_FCST_BL_GC        = ict_final[STR_DF_OUT_SI_FCST_BL_GC   ]
        df_output_Sell_In_FCST_BL_Local     = ict_final[STR_DF_OUT_SI_FCST_BL_LOCAL]
        df_output_Sell_Out_FCST_AP1         = ict_final[STR_DF_OUT_SO_FCST_AP1     ]
        df_output_Sell_Out_FCST_AP2         = ict_final[STR_DF_OUT_SO_FCST_AP2     ]
        df_output_Sell_Out_FCST_GC          = ict_final[STR_DF_OUT_SO_FCST_GC      ]
        df_output_Sell_Out_FCST_Local       = ict_final[STR_DF_OUT_SO_FCST_LOCAL   ]
        df_output_Channel_Inv_AP1           = ict_final[STR_DF_OUT_CH_INV_AP1      ]
        df_output_Channel_Inv_AP2           = ict_final[STR_DF_OUT_CH_INV_AP2      ]
        df_output_Channel_Inv_GC            = ict_final[STR_DF_OUT_CH_INV_GC       ]
        df_output_Channel_Inv_Local         = ict_final[STR_DF_OUT_CH_INV_LOCAL    ]
        df_output_Channel_Inv_Floor_AP1     = ict_final[STR_DF_OUT_CH_INV_FLR_AP1  ]
        df_output_Channel_Inv_Floor_AP2     = ict_final[STR_DF_OUT_CH_INV_FLR_AP2  ]
        df_output_Channel_Inv_Floor_GC      = ict_final[STR_DF_OUT_CH_INV_FLR_GC   ]
        df_output_Channel_Inv_Floor_Local   = ict_final[STR_DF_OUT_CH_INV_FLR_LOCAL]   
