...
str_instance = 'PYSalesProductASNDeltaeStore'
...
# =========================
# eStore Ratio (주차 기준) 측정치 컬럼들
# 공통 suffix 순서: Long Tail, W+7, W+6, W+5, W+4, W+3, W+2, W+1, W+0
# =========================
ESTORE_RATIO_SUFFIXES = [
    '(Long Tail)', '(W+7)', '(W+6)', '(W+5)', '(W+4)', '(W+3)', '(W+2)', '(W+1)', '(W+0)'
]

# 7-1 계열: User GI Ratio
COLS_SIN_USER_GI_RATIO = [
    'S/In User GI Ratio(Long Tail)','S/In User GI Ratio(W+7)','S/In User GI Ratio(W+6)',
    'S/In User GI Ratio(W+5)','S/In User GI Ratio(W+4)','S/In User GI Ratio(W+3)',
    'S/In User GI Ratio(W+2)','S/In User GI Ratio(W+1)','S/In User GI Ratio(W+0)'
]

# 7-2 계열: Issue GI Ratio
COLS_SIN_ISSUE_GI_RATIO = [
    'S/In Issue GI Ratio(Long Tail)','S/In Issue GI Ratio(W+7)','S/In Issue GI Ratio(W+6)',
    'S/In Issue GI Ratio(W+5)','S/In Issue GI Ratio(W+4)','S/In Issue GI Ratio(W+3)',
    'S/In Issue GI Ratio(W+2)','S/In Issue GI Ratio(W+1)','S/In Issue GI Ratio(W+0)'
]

# 7-3 계열: Final GI Ratio
COLS_SIN_FINAL_GI_RATIO = [
    'S/In Final GI Ratio(Long Tail)','S/In Final GI Ratio(W+7)','S/In Final GI Ratio(W+6)',
    'S/In Final GI Ratio(W+5)','S/In Final GI Ratio(W+4)','S/In Final GI Ratio(W+3)',
    'S/In Final GI Ratio(W+2)','S/In Final GI Ratio(W+1)','S/In Final GI Ratio(W+0)'
]

# 7-4 계열: BestFit GI Ratio
COLS_SIN_BESTFIT_GI_RATIO = [
    'S/In BestFit GI Ratio(Long Tail)','S/In BestFit GI Ratio(W+7)','S/In BestFit GI Ratio(W+6)',
    'S/In BestFit GI Ratio(W+5)','S/In BestFit GI Ratio(W+4)','S/In BestFit GI Ratio(W+3)',
    'S/In BestFit GI Ratio(W+2)','S/In BestFit GI Ratio(W+1)','S/In BestFit GI Ratio(W+0)'
]

# 7-5 계열: User Item GI Ratio
COLS_SIN_USER_ITEM_GI_RATIO = [
    'S/In User Item GI Ratio(Long Tail)','S/In User Item GI Ratio(W+7)','S/In User Item GI Ratio(W+6)',
    'S/In User Item GI Ratio(W+5)','S/In User Item GI Ratio(W+4)','S/In User Item GI Ratio(W+3)',
    'S/In User Item GI Ratio(W+2)','S/In User Item GI Ratio(W+1)','S/In User Item GI Ratio(W+0)'
]

# 7-6 계열: Issue Item GI Ratio
COLS_SIN_ISSUE_ITEM_GI_RATIO = [
    'S/In Issue Item GI Ratio(Long Tail)','S/In Issue Item GI Ratio(W+7)','S/In Issue Item GI Ratio(W+6)',
    'S/In Issue Item GI Ratio(W+5)','S/In Issue Item GI Ratio(W+4)','S/In Issue Item GI Ratio(W+3)',
    'S/In Issue Item GI Ratio(W+2)','S/In Issue Item GI Ratio(W+1)','S/In Issue Item GI Ratio(W+0)'
]

# 7-7 계열: User Modify GI Ratio
COLS_SIN_USER_MODIFY_GI_RATIO = [
    'S/In User Modify GI Ratio(Long Tail)','S/In User Modify GI Ratio(W+7)','S/In User Modify GI Ratio(W+6)',
    'S/In User Modify GI Ratio(W+5)','S/In User Modify GI Ratio(W+4)','S/In User Modify GI Ratio(W+3)',
    'S/In User Modify GI Ratio(W+2)','S/In User Modify GI Ratio(W+1)','S/In User Modify GI Ratio(W+0)'
]

# 7-8 계열: Issue Modify GI Ratio
COLS_SIN_ISSUE_MODIFY_GI_RATIO = [
    'S/In Issue Modify GI Ratio(Long Tail)','S/In Issue Modify GI Ratio(W+7)','S/In Issue Modify GI Ratio(W+6)',
    'S/In Issue Modify GI Ratio(W+5)','S/In Issue Modify GI Ratio(W+4)','S/In Issue Modify GI Ratio(W+3)',
    'S/In Issue Modify GI Ratio(W+2)','S/In Issue Modify GI Ratio(W+1)','S/In Issue Modify GI Ratio(W+0)'
]
...
# =========================
# eStore Ratio 입력 DF 키 (스펙 Input 23~38)
# (PG 집계본은 Step 7-00에서 생성하는 내부 가공테이블)
# =========================
DF_IN_SIN_USER_GI_RATIO            = 'df_in_Sell_In_User_GI_Ratio'                  # 23
DF_IN_SIN_ISSUE_GI_RATIO           = 'df_in_Sell_In_Issue_GI_Ratio'                 # 24
DF_IN_SIN_FINAL_GI_RATIO           = 'df_in_Sell_In_Final_GI_Ratio'                 # 25
DF_IN_SIN_BESTFIT_GI_RATIO         = 'df_in_Sell_In_BestFit_GI_Ratio'               # 26
DF_IN_SIN_USER_ITEM_GI_RATIO       = 'df_in_Sell_In_User_Item_GI_Ratio'             # 27
DF_IN_SIN_ISSUE_ITEM_GI_RATIO      = 'df_in_Sell_In_Issue_Item_GI_Ratio'            # 28
DF_IN_SIN_USER_MODIFY_GI_RATIO     = 'df_in_Sell_In_User_Modify_GI_Ratio'           # 29
DF_IN_SIN_ISSUE_MODIFY_GI_RATIO    = 'df_in_Sell_In_Issue_Modify_GI_Ratio'          # 30

DF_IN_SIN_USER_GI_RATIO_ITEM       = 'df_in_Sell_In_User_GI_Ratio_Item'             # 31
DF_IN_SIN_ISSUE_GI_RATIO_ITEM      = 'df_in_Sell_In_Issue_GI_Ratio_Item'            # 32
DF_IN_SIN_FINAL_GI_RATIO_ITEM      = 'df_in_Sell_In_Final_GI_Ratio_Item'            # 33
DF_IN_SIN_BESTFIT_GI_RATIO_ITEM    = 'df_in_Sell_In_BestFit_GI_Ratio_Item'          # 34
DF_IN_SIN_USER_ITEM_GI_RATIO_ITEM  = 'df_in_Sell_In_User_Item_GI_Ratio_Item'        # 35
DF_IN_SIN_ISSUE_ITEM_GI_RATIO_ITEM = 'df_in_Sell_In_Issue_Item_GI_Ratio_Item'       # 36
DF_IN_SIN_USER_MODIFY_GI_RATIO_ITEM= 'df_in_Sell_In_User_Modify_GI_Ratio_Item'      # 37
DF_IN_SIN_ISSUE_MODIFY_GI_RATIO_ITEM='df_in_Sell_In_Issue_Modify_GI_Ratio_Item'     # 38

# Step 7-00: PG(=Item Std1) 집계본 내부 가공 DF 키
DF_PG_SIN_USER_GI_RATIO            = 'df_in_Sell_In_User_GI_Ratio_PG'
DF_PG_SIN_ISSUE_GI_RATIO           = 'df_in_Sell_In_Issue_GI_Ratio_PG'
DF_PG_SIN_FINAL_GI_RATIO           = 'df_in_Sell_In_Final_GI_Ratio_PG'
DF_PG_SIN_BESTFIT_GI_RATIO         = 'df_in_Sell_In_BestFit_GI_Ratio_PG'
DF_PG_SIN_USER_ITEM_GI_RATIO       = 'df_in_Sell_In_User_Item_GI_Ratio_PG'
DF_PG_SIN_ISSUE_ITEM_GI_RATIO      = 'df_in_Sell_In_Issue_Item_GI_Ratio_PG'
DF_PG_SIN_USER_MODIFY_GI_RATIO     = 'df_in_Sell_In_User_Modify_GI_Ratio_PG'
DF_PG_SIN_ISSUE_MODIFY_GI_RATIO    = 'df_in_Sell_In_Issue_Modify_GI_Ratio_PG'

# =========================
# eStore Ratio 출력 DF 키 (Output 7-1 ~ 7-8)
# =========================
DF_OUT_SIN_USER_GI_RATIO           = 'df_output_Sell_In_User_GI_Ratio'
DF_OUT_SIN_ISSUE_GI_RATIO          = 'df_output_Sell_In_Issue_GI_Ratio'
DF_OUT_SIN_FINAL_GI_RATIO          = 'df_output_Sell_In_Final_GI_Ratio'
DF_OUT_SIN_BESTFIT_GI_RATIO        = 'df_output_Sell_In_BestFit_GI_Ratio'
DF_OUT_SIN_USER_ITEM_GI_RATIO      = 'df_output_Sell_In_User_Item_GI_Ratio'
DF_OUT_SIN_ISSUE_ITEM_GI_RATIO     = 'df_output_Sell_In_Issue_Item_GI_Ratio'
DF_OUT_SIN_USER_MODIFY_GI_RATIO    = 'df_output_Sell_In_User_Modify_GI_Ratio'
DF_OUT_SIN_ISSUE_MODIFY_GI_RATIO   = 'df_output_Sell_In_Issue_Modify_GI_Ratio'

RATIO_GROUPS = {
    'USER_GI': {
        'cols': COLS_SIN_USER_GI_RATIO,
        'df_in': DF_IN_SIN_USER_GI_RATIO,
        'df_in_item': DF_IN_SIN_USER_GI_RATIO_ITEM,
        'df_pg': DF_PG_SIN_USER_GI_RATIO,
        'df_out': DF_OUT_SIN_USER_GI_RATIO,
    },
    'ISSUE_GI': {
        'cols': COLS_SIN_ISSUE_GI_RATIO,
        'df_in': DF_IN_SIN_ISSUE_GI_RATIO,
        'df_in_item': DF_IN_SIN_ISSUE_GI_RATIO_ITEM,
        'df_pg': DF_PG_SIN_ISSUE_GI_RATIO,
        'df_out': DF_OUT_SIN_ISSUE_GI_RATIO,
    },
    'FINAL_GI': {
        'cols': COLS_SIN_FINAL_GI_RATIO,
        'df_in': DF_IN_SIN_FINAL_GI_RATIO,
        'df_in_item': DF_IN_SIN_FINAL_GI_RATIO_ITEM,
        'df_pg': DF_PG_SIN_FINAL_GI_RATIO,
        'df_out': DF_OUT_SIN_FINAL_GI_RATIO,
    },
    'BESTFIT_GI': {
        'cols': COLS_SIN_BESTFIT_GI_RATIO,
        'df_in': DF_IN_SIN_BESTFIT_GI_RATIO,
        'df_in_item': DF_IN_SIN_BESTFIT_GI_RATIO_ITEM,
        'df_pg': DF_PG_SIN_BESTFIT_GI_RATIO,
        'df_out': DF_OUT_SIN_BESTFIT_GI_RATIO,
    },
    'USER_ITEM_GI': {
        'cols': COLS_SIN_USER_ITEM_GI_RATIO,
        'df_in': DF_IN_SIN_USER_ITEM_GI_RATIO,
        'df_in_item': DF_IN_SIN_USER_ITEM_GI_RATIO_ITEM,
        'df_pg': DF_PG_SIN_USER_ITEM_GI_RATIO,
        'df_out': DF_OUT_SIN_USER_ITEM_GI_RATIO,
    },
    'ISSUE_ITEM_GI': {
        'cols': COLS_SIN_ISSUE_ITEM_GI_RATIO,
        'df_in': DF_IN_SIN_ISSUE_ITEM_GI_RATIO,
        'df_in_item': DF_IN_SIN_ISSUE_ITEM_GI_RATIO_ITEM,
        'df_pg': DF_PG_SIN_ISSUE_ITEM_GI_RATIO,
        'df_out': DF_OUT_SIN_ISSUE_ITEM_GI_RATIO,
    },
    'USER_MODIFY_GI': {
        'cols': COLS_SIN_USER_MODIFY_GI_RATIO,
        'df_in': DF_IN_SIN_USER_MODIFY_GI_RATIO,
        'df_in_item': DF_IN_SIN_USER_MODIFY_GI_RATIO_ITEM,
        'df_pg': DF_PG_SIN_USER_MODIFY_GI_RATIO,
        'df_out': DF_OUT_SIN_USER_MODIFY_GI_RATIO,
    },
    'ISSUE_MODIFY_GI': {
        'cols': COLS_SIN_ISSUE_MODIFY_GI_RATIO,
        'df_in': DF_IN_SIN_ISSUE_MODIFY_GI_RATIO,
        'df_in_item': DF_IN_SIN_ISSUE_MODIFY_GI_RATIO_ITEM,
        'df_pg': DF_PG_SIN_ISSUE_MODIFY_GI_RATIO,
        'df_out': DF_OUT_SIN_ISSUE_MODIFY_GI_RATIO,
    },
}
...
def fn_log_dataframe(df_p_source: pd.DataFrame, str_p_source_name: str,int_p_row_num: int = 20) -> None:
    ...
    # ✅ o9에서 debug가 안 보일 수 있으니, 분석 모드에서는 INFO로 강제
    force_info = (not is_local)  # Linux(o9)면 True
    ...
    if is_print:
        ...
        logger.PrintDF(
            ...
            p_log_level=LOG_LEVEL.info() if force_info else LOG_LEVEL.debug(),  # ✅ 핵심
            p_format=1,
            p_row_num=int_p_row_num
        )
...
def fn_process_in_df_mst():
    """
    PYSalesProductASNDeltaeStore: 입력 DF 적재 + 타입 표준화
      - 차원(prefix): "Version.", "Sales Domain", "Item.", "Location.", "Time." → category
        (Time 은 Partial Week/Week 모두 포함)
      - 측정치(더미/가격/환율/Split Ratio/AP 가격/eStore Ratio): float32 (NaN 보존)
      - 정수 코드값만 int32
    전역 dict: input_dataframes 에 적재
    """    
    
    # -----------------------------
    # 0) 파일명 ↔ DF_KEY 매핑 (CSV 로컬 적재용)
    #    파일명은 <DF_KEY>.csv 규칙이어야 함
    # -----------------------------
    file_to_df_mapping = {
        # --- 기존 B2C 공통 ---
        ...
        # --- eStore 신규 입력 (23~38) ---
        f'{DF_IN_SIN_USER_GI_RATIO            }.csv': DF_IN_SIN_USER_GI_RATIO,             # 23
        f'{DF_IN_SIN_ISSUE_GI_RATIO           }.csv': DF_IN_SIN_ISSUE_GI_RATIO,            # 24
        f'{DF_IN_SIN_FINAL_GI_RATIO           }.csv': DF_IN_SIN_FINAL_GI_RATIO,            # 25
        f'{DF_IN_SIN_BESTFIT_GI_RATIO         }.csv': DF_IN_SIN_BESTFIT_GI_RATIO,          # 26
        f'{DF_IN_SIN_USER_ITEM_GI_RATIO       }.csv': DF_IN_SIN_USER_ITEM_GI_RATIO,        # 27
        f'{DF_IN_SIN_ISSUE_ITEM_GI_RATIO      }.csv': DF_IN_SIN_ISSUE_ITEM_GI_RATIO,       # 28
        f'{DF_IN_SIN_USER_MODIFY_GI_RATIO     }.csv': DF_IN_SIN_USER_MODIFY_GI_RATIO,      # 29
        f'{DF_IN_SIN_ISSUE_MODIFY_GI_RATIO    }.csv': DF_IN_SIN_ISSUE_MODIFY_GI_RATIO,     # 30

        f'{DF_IN_SIN_USER_GI_RATIO_ITEM       }.csv': DF_IN_SIN_USER_GI_RATIO_ITEM,        # 31
        f'{DF_IN_SIN_ISSUE_GI_RATIO_ITEM      }.csv': DF_IN_SIN_ISSUE_GI_RATIO_ITEM,       # 32
        f'{DF_IN_SIN_FINAL_GI_RATIO_ITEM      }.csv': DF_IN_SIN_FINAL_GI_RATIO_ITEM,       # 33
        f'{DF_IN_SIN_BESTFIT_GI_RATIO_ITEM    }.csv': DF_IN_SIN_BESTFIT_GI_RATIO_ITEM,     # 34
        f'{DF_IN_SIN_USER_ITEM_GI_RATIO_ITEM  }.csv': DF_IN_SIN_USER_ITEM_GI_RATIO_ITEM,   # 35
        f'{DF_IN_SIN_ISSUE_ITEM_GI_RATIO_ITEM }.csv': DF_IN_SIN_ISSUE_ITEM_GI_RATIO_ITEM,  # 36
        f'{DF_IN_SIN_USER_MODIFY_GI_RATIO_ITEM}.csv': DF_IN_SIN_USER_MODIFY_GI_RATIO_ITEM, # 37
        f'{DF_IN_SIN_ISSUE_MODIFY_GI_RATIO_ITEM}.csv': DF_IN_SIN_ISSUE_MODIFY_GI_RATIO_ITEM,# 38
    ...
    if is_local:
        ...
        input_dataframes[DF_IN_SIN_USER_MODIFY_GI_RATIO     ] = df_in_Sell_In_User_Modify_GI_Ratio
        input_dataframes[DF_IN_SIN_ISSUE_MODIFY_GI_RATIO    ] = df_in_Sell_In_Issue_Modify_GI_Ratio

        input_dataframes[DF_IN_SIN_USER_GI_RATIO_ITEM       ] = df_in_Sell_In_User_GI_Ratio_Item
        input_dataframes[DF_IN_SIN_ISSUE_GI_RATIO_ITEM      ] = df_in_Sell_In_Issue_GI_Ratio_Item
        input_dataframes[DF_IN_SIN_FINAL_GI_RATIO_ITEM      ] = df_in_Sell_In_Final_GI_Ratio_Item
        input_dataframes[DF_IN_SIN_BESTFIT_GI_RATIO_ITEM    ] = df_in_Sell_In_BestFit_GI_Ratio_Item
        input_dataframes[DF_IN_SIN_USER_ITEM_GI_RATIO_ITEM  ] = df_in_Sell_In_User_Item_GI_Ratio_Item
        input_dataframes[DF_IN_SIN_ISSUE_ITEM_GI_RATIO_ITEM ] = df_in_Sell_In_Issue_Item_GI_Ratio_Item
        input_dataframes[DF_IN_SIN_USER_MODIFY_GI_RATIO_ITEM] = df_in_Sell_In_User_Modify_GI_Ratio_Item
        input_dataframes[DF_IN_SIN_ISSUE_MODIFY_GI_RATIO_ITEM] = df_in_Sell_In_Issue_Modify_GI_Ratio_Item
    ...
    # -----------------------------
    # 기존 + eStore Ratio 8개 패밀리(…Item 포함) 접두어 모두 추가
    meas_starts = (
        # 기존 계열
        ...
        "Split Ratio",           # 안전빵: 'Split Ratio' 로만 오는 경우

        # eStore Ratio 계열(23~30)
        "S/In User GI Ratio",
        "S/In Issue GI Ratio",
        "S/In Final GI Ratio",
        "S/In BestFit GI Ratio",
        "S/In User Item GI Ratio",
        "S/In Issue Item GI Ratio",
        "S/In User Modify GI Ratio",
        "S/In Issue Modify GI Ratio",
    )
...
# ======================================================
# Step 01: 생성할 Dummy 선별 (+ 삭제용 Output 구성)  [eStore 버전]
#   * 차이점
#     - Step 1-0: SDD에서 eStore ShipTo만 "포함" (B2C는 제외)
#     - Flooring 더미(1-5, 1-6)는 eStore에선 미사용 → 빈 DF 반환
# ======================================================# ---------- (재확인) 컬럼 상수 ----------
# COL_VERSION   = 'Version.[Version Name]'
# COL_SHIP_TO   = 'Sales Domain.[Ship To]'
# COL_ITEM      = 'Item.[Item]'
...
# COL_FLOORING_DUMMY = 'Flooring FCST Dummy'   # (eStore에서는 미사용)

# ---------- 유틸 ----------
def _coerce_dims(df: pd.DataFrame, cols: list[str]) -> None:
    for c in cols:
        if c in df.columns and df[c].dtype.name != 'category':
            df[c] = df[c].astype('category')

def _to_float32(df: pd.DataFrame, cols: list[str]) -> None:
    for c in cols:
        if c in df.columns:
            df[c] = pd.to_numeric(df[c], errors='coerce').astype('float32')

def _any_positive_or_notnull(df: pd.DataFrame, cols: list[str]) -> pd.Series:
    valid = [c for c in cols if c in df.columns]
    if not valid:
        return pd.Series(False, index=df.index)
    mask_notnull = df[valid].notna().any(axis=1)
    mask_gt0 = (pd.DataFrame({c: pd.to_numeric(df[c], errors='coerce') for c in valid}) > 0).any(axis=1)
    return (mask_notnull | mask_gt0)

def _empty_like_sin_dummy(out_version: str) -> pd.DataFrame:
    cols = [COL_VERSION, COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_PW] + SIN_DUMMY_COLS
    df = pd.DataFrame(columns=cols)
    _coerce_dims(df, [COL_VERSION, COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_PW])
    _to_float32(df, SIN_DUMMY_COLS)
    return df

def _empty_like_sout_dummy(out_version: str) -> pd.DataFrame:
    cols = [COL_VERSION, COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_PW] + SOUT_DUMMY_COLS
    df = pd.DataFrame(columns=cols)
    _coerce_dims(df, [COL_VERSION, COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_PW])
    _to_float32(df, SOUT_DUMMY_COLS)
    return df

def _empty_like_flooring_dummy(out_version: str) -> pd.DataFrame:
    # eStore는 미사용. 호환성 유지를 위해 스켈레톤만 제공
...
def fn_step01_00_select_sales(
    ...
    **kwargs
    ...
    if df_in_estore is not None and not df_in_estore.empty and (COL_SHIP_TO in df_in_estore.columns):
        estore_set = set(df_in_estore[COL_SHIP_TO].astype('string').unique())
        df_pairs = df_pairs[df_pairs[COL_SHIP_TO].astype('string').isin(estore_set)].copy()

    # SDD에 존재하는 ShipTo만 남김(유효성)
    if df_in_sdd is not None and not df_in_sdd.empty and (COL_SHIP_TO in df_in_sdd.columns):
        sdd_set = set(df_in_sdd[COL_SHIP_TO].astype('string').unique())
        df_pairs = df_pairs[df_pairs[COL_SHIP_TO].astype('string').isin(sdd_set)].copy()
...
def fn_step01_01_pick_sin_dummy(
    ...
    # return _coerce_dims(work, (COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_PW))
    return work
...
########################################################################################################################
# Step 1-5) Flooring 더미에서 생성할 Sales 선정  [eStore: 미사용 → 항상 빈 DF]
########################################################################################################################
@_decoration_
def fn_step01_05_pick_flooring_dummy(
    ...
    """
    Step 1-5) Flooring 더미 (eStore 미사용)
    ----------------------------------------------------------
    • 스펙상 사용하지 않으므로 항상 빈 스키마 반환
    """
    return _empty_like_flooring_dummy(out_version='')

########################################################################################################################
# Step 1-6) Flooring 더미 Output 구성(삭제용)  [eStore: 미사용 → 항상 빈 DF]
########################################################################################################################
@_decoration_
def fn_step01_06_build_output_flooring_dummy_delete(
    ...
    """
    Step 1-6) Flooring 더미 Output 구성 (eStore 미사용)
    ----------------------------------------------------------
    • 스펙상 사용하지 않으므로 항상 빈 스키마 반환
    """
    return _empty_like_flooring_dummy(out_version)
...
#   입력: df_step01_03_sout_pick (PW 축 포함)
#   출력: [ShipTo, Item, (Location)], S/Out FCST Assortment_APx
#   처리: Dummy→Assortment rename, (0→1 변환), Time(PW) 축 제거(집계), dtype 정리
# ======================================================
@_decoration_
def fn_step02_02_build_sout_assortment(
    ...
    if df_sout_pick is None or df_sout_pick.empty or (sout_dummy_col not in df_sout_pick.columns):
        cols = [COL_SHIP_TO, COL_ITEM]
        if COL_LOCATION in (df_sout_pick.columns if df_sout_pick is not None else []):
            cols.append(COL_LOCATION)
    ...
    # ShipTo*Item*(Location) 단위로 max 집계 → Time(PW) 축 자연스럽게 제거
    work = ultra_fast_groupby_numpy_general(
        df=work,
        key_cols=dim_cols,
        aggs={
...
def fn_step04_01_build_est_price_local(
    ...
    df[COL_MONTH] = df[COL_PW].astype('string').map(_pweek_to_month_str)
...
def fn_step04_02_fill_missing_price_from_children(
    ...
    **kwargs
    ...
    existing_shipto = set(df_est_local[COL_SHIP_TO].astype('string').unique())
    parent_children = {
...
########################################################################################################################
# Step 7 — eStore Ratio Data 생성
########################################################################################################################
########################################################################################################################
# Step 7 — eStore Ratio (공통 로직)
########################################################################################################################
...
def _build_pg_from_shipto(df_shipto_pg: pd.DataFrame, ratio_cols: list[str]) -> pd.DataFrame:
    """
    Step 7-00: ShipTo가 있는 23~30 원본에서
    Item Std1 + Location + Week 기준 평균을 내서 PG 테이블 생성 (Ship To 제거)
    """
    key_cols = ["Item.[Item Std1]", "Location.[Location]", "Time.[Week]"]
    need_cols = key_cols + ratio_cols
    df = df_shipto_pg[need_cols + (["Sales Domain.[Ship To]"] if "Sales Domain.[Ship To]" in df_shipto_pg.columns else [])].copy()
    df = _ensure_numeric_cols(df, ratio_cols)
    df_pg = df.groupby(key_cols, as_index=False)[ratio_cols].mean()
    # 컬럼 순서 고정
    return df_pg[key_cols + ratio_cols]

# ──────────────────────────────────────────────────────────────────────────────
# 7-0) 대상 선정: S/In 더미 ∩ S/Out 더미  (ShipTo*Item*Location)
# ──────────────────────────────────────────────────────────────────────────────
@_decoration_
def fn_step07_0_select_targets(
    df_step01_01_sin_pick : pd.DataFrame,   # Step 1-1 결과
    df_step01_03_sout_pick: pd.DataFrame,   # Step 1-3 결과
    **kwargs
) -> pd.DataFrame:
    cols = [COL_SHIP_TO, COL_ITEM, COL_LOCATION]
    if df_step01_01_sin_pick is None or df_step01_01_sin_pick.empty: return pd.DataFrame(columns=cols)
    if df_step01_03_sout_pick is None or df_step01_03_sout_pick.empty: return pd.DataFrame(columns=cols)

    s = df_step01_01_sin_pick[cols].drop_duplicates()
    o = df_step01_03_sout_pick[cols].drop_duplicates()
    out = s.merge(o, on=cols, how='inner')
    for c in cols:
...
# ──────────────────────────────────────────────────────────────────────────────
# 7-00) input 23~30 입력 → PG(Item Std1) 집계본 생성
#       groupby([Item Std1, Location, Week]).mean()  (ShipTo 제거!)
# ──────────────────────────────────────────────────────────────────────────────
@_decoration_
def fn_step07_00_build_pg_ratio_tables(
    dict_dfs   : dict,   # input_dataframes
    **kwargs
) -> dict:
    if not dict_dfs: return {}

    out_dict = {}
    for k, meta in RATIO_GROUPS.items():
        in_key  = meta['df_in']     # 23~30
        pg_key  = meta['df_pg']     # *_PG (출력)
        cols_meas = meta['cols']

        df_src = dict_dfs.get(in_key, pd.DataFrame())
        cols_need = [COL_ITEM_STD1, COL_LOCATION, COL_WEEK]
        if df_src is None or df_src.empty or any(c not in df_src.columns for c in cols_need):
            df_pg = pd.DataFrame(columns=[COL_ITEM_STD1, COL_LOCATION, COL_WEEK, *cols_meas])
        else:
            use = df_src[[c for c in [*cols_need, *cols_meas] if c in df_src.columns]].copy(deep=False)
            # 숫자화
            for m in cols_meas:
                if m in use.columns:
                    use[m] = pd.to_numeric(use[m], errors='coerce')
            # ★ ShipTo 제거하고 AVG
            df_pg = use.groupby([COL_ITEM_STD1, COL_LOCATION, COL_WEEK], as_index=False)[
                [c for c in cols_meas if c in use.columns]
            ].mean()

            for c in (COL_ITEM_STD1, COL_LOCATION, COL_WEEK):
                if df_pg[c].dtype.name != 'category':
                    df_pg[c] = df_pg[c].astype('category')
            for m in cols_meas:
                if m not in df_pg.columns:
                    df_pg[m] = np.nan
                df_pg[m] = df_pg[m].astype('float32')

            df_pg = df_pg[[COL_ITEM_STD1, COL_LOCATION, COL_WEEK, *cols_meas]]
        # input_dataframes
        dict_dfs[pg_key] = df_pg
        # 로그를 찍기 위한 객체
        out_dict[pg_key] = df_pg
    return out_dict

# ──────────────────────────────────────────────────────────────────────────────
# 내부 유틸: 스켈레톤 생성 (ShipTo, Item, Location) × Time.[Week] + ItemStd1 매핑
# ──────────────────────────────────────────────────────────────────────────────
def _expand_s3_by_week(df_targets: pd.DataFrame, df_time_w: pd.DataFrame) -> pd.DataFrame:
    if df_targets is None or df_targets.empty or df_time_w is None or df_time_w.empty:
        return pd.DataFrame(columns=[COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_WEEK])

    base = df_targets[[COL_SHIP_TO, COL_ITEM, COL_LOCATION]].drop_duplicates(ignore_index=True)
    for c in (COL_SHIP_TO, COL_ITEM, COL_LOCATION):
        if base[c].dtype.name != 'category':
            base[c] = base[c].astype('category')

    s_w = df_time_w[COL_WEEK]
    if s_w.dtype.name != 'category':
        s_w = s_w.astype('category')

    t = pd.DataFrame({COL_WEEK: s_w.values})
    n_b, n_t = len(base), len(t)
    rep_b = base.loc[base.index.repeat(n_t)].reset_index(drop=True)
    tile_t = pd.concat([t]*n_b, ignore_index=True)
    df = pd.concat([rep_b, tile_t], axis=1)
    df[COL_WEEK] = df[COL_WEEK].astype('category')
    return df

def _make_week_skeleton_with_std1(
    df_targets : pd.DataFrame,
    df_time_w  : pd.DataFrame,
    df_item_mst: pd.DataFrame
) -> pd.DataFrame:
    skel = _expand_s3_by_week(df_targets, df_time_w)  # [ShipTo, Item, Location, Week]
    if skel.empty:
        return skel
    # Item → Item Std1
    if df_item_mst is None or df_item_mst.empty or COL_ITEM_STD1 not in df_item_mst.columns:
        skel[COL_ITEM_STD1] = np.nan
    else:
        m = df_item_mst[[COL_ITEM, COL_ITEM_STD1]].drop_duplicates()
        skel = skel.merge(m, on=COL_ITEM, how='left')
    if skel[COL_ITEM_STD1].dtype.name != 'category':
        skel[COL_ITEM_STD1] = skel[COL_ITEM_STD1].astype('category')
    return skel

# ──────────────────────────────────────────────────────────────────────────────
# 7-1 ~ 7-8 공통 로직 (25.?? GI Ratio Spec 보완 버전)
#   - 신규 여부 판정:
#       exists_item_in_item      : df_in_item 에 Item 이 존재하는지 (Item 단위)
#       exists_shipto_in_item    : df_in_item 에 (ShipTo, Item) 조합이 존재하는지
#
#   - 처리 규칙 (각 row 기준)
#       0) 사전 판정
#          0-1) exists_item_in_item  := df_in_item 에 Item.[Item] 이 존재하는지
#          0-2) exists_shipto_in_item:= df_in_item 에 (Sales Domain.[Ship To], Item.[Item]) 조합이 존재하는지
#
#       1) exists_item_in_item == False (신규 Item)
#           → df_in_shiptopg (ShipTo + ItemStd1(PG) + Location + Week) 에서 값 사용
#           → ShipTo, PG(ItemStd1), Location 이 모두 일치하지 않으면 값 생성 X (NaN 유지)
#
#       2) exists_item_in_item == True AND exists_shipto_in_item == False
#           → df_in_pg (ItemStd1(PG) + Location + Week) 에서 값 사용
#           → PG, Location 이 일치하지 않으면 값 생성 X (NaN 유지)
#
#       3) exists_shipto_in_item == True
#           → Data 생성하지 않음 → 해당 row 제거
#
#   - 참고
#       * 신규 Item  : ShipTo - Product Group(Item Std1) - Location 평균값 사용 (케이스 1)
#       * 신규 ShipTo: Product Group - Location 평균값 사용 (케이스 2)
#       * 신규 Location: Python 에서 처리하지 않으며, UI 에서 관리 (여기서는 값 없음 그대로)
# ──────────────────────────────────────────────────────────────────────────────
def _fn_step07_build_ratio_common(
    group_key: str,
    df_targets: pd.DataFrame,     # Step 7-0 결과 (ShipTo, Item, Location)
    df_time_w: pd.DataFrame,      # Time.[Week] 단일 컬럼
    df_item_mst: pd.DataFrame,    # Item -> Item Std1 매핑
    df_in_item: pd.DataFrame,     # (기존) ShipTo+Item+Location+Week 레벨
    df_in_shiptopg: pd.DataFrame, # ShipTo+ItemStd1+Location+Week 레벨 (ShipTo-PG-Location)
    df_in_pg: pd.DataFrame,       # ItemStd1+Location+Week 레벨 (PG-Location)
    ratio_cols: list[str],
    out_version: str,
    *,
    round_digits: int = 10,       # (필요 시 사용 가능, 현재는 dtype 정리만)
) -> pd.DataFrame:
    # 0) 입력 방어 & 사전 정리 -------------------------------------------------
    if df_targets is None or df_targets.empty or df_time_w is None or df_time_w.empty:
        cols = [COL_VERSION, COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_WEEK] + ratio_cols
        return pd.DataFrame(columns=cols)

    # df_in_* 방어: 없으면 스키마만 만들어둠
    df_in_item = df_in_item.copy() if df_in_item is not None else pd.DataFrame(
        columns=[COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_WEEK] + ratio_cols
    )
    df_in_shiptopg = df_in_shiptopg.copy() if df_in_shiptopg is not None else pd.DataFrame(
        columns=[COL_SHIP_TO, COL_ITEM_STD1, COL_LOCATION, COL_WEEK] + ratio_cols
    )
    df_in_pg = df_in_pg.copy() if df_in_pg is not None else pd.DataFrame(
        columns=[COL_ITEM_STD1, COL_LOCATION, COL_WEEK] + ratio_cols
    )

    _ensure_numeric_cols(df_in_item, ratio_cols)
    _ensure_numeric_cols(df_in_shiptopg, ratio_cols)
    _ensure_numeric_cols(df_in_pg, ratio_cols)

    # 1) 대상(Targets) × 주차 그리드 생성 --------------------------------------
    #    Step 7-0 대상(df_targets: ShipTo,Item,Location) 에 Week 축을 cross join
    base = df_targets.merge(df_time_w, how="cross")  # [ShipTo, Item, Location, Week]

    # 1-1) Item Std1(PG) 매핑 --------------------------------------------------
    if df_item_mst is not None and not df_item_mst.empty and COL_ITEM_STD1 in df_item_mst.columns:
        base = base.merge(
            df_item_mst[[COL_ITEM, COL_ITEM_STD1]].drop_duplicates(),
            on=COL_ITEM,
            how="left"
        )
    if COL_ITEM_STD1 not in base.columns:
        base[COL_ITEM_STD1] = np.nan

    # ────────────────────────────────────────────────────────────────────────
    # (DEBUG) 여기서부터 "관련 데이터만" 로그: base 기준으로 key set 1회만 만들기
    # ────────────────────────────────────────────────────────────────────────
    # if group_key == 'FINAL_GI':
    #     logger.debug('_fn_step07_build_ratio_common FINAL_GI 로그분석')
    #     logger.debug(f'group_key : {group_key}')
    #     logger.debug('Process 대상(fn_step07_0(step01_01 + step01_03))')
    #     fn_log_dataframe(df_targets,'df_step07_03_df_targets',None)

    #     # base에서 한 번만 key set 구성 (mask 최소화)
    #     shipto_set = set(base[COL_SHIP_TO].dropna().astype(str).unique())
    #     item_set   = set(base[COL_ITEM].dropna().astype(str).unique())
    #     loc_set    = set(base[COL_LOCATION].dropna().astype(str).unique())
    #     week_set   = set(base[COL_WEEK].dropna().astype(str).unique())
    #     pg_set     = set(base[COL_ITEM_STD1].dropna().astype(str).unique())  # PG

    #     logger.debug('Process 대상(base = targets x weeks + PG mapped)')
    #     fn_log_dataframe(base, 'df_step07_03_base_targets_x_week', None)

    #     # 1) ShipTo-Item-Location-Week 레벨(df_in_item) : 관련 shipto+item(+loc+week)만
    #     if not df_in_item.empty:
    #         # 최소 mask: shipto & item 먼저, 필요하면 loc/week까지
    #         m_item = df_in_item[COL_ITEM].astype(str).isin(item_set) if COL_ITEM in df_in_item.columns else False
    #         m_ship = df_in_item[COL_SHIP_TO].astype(str).isin(shipto_set) if COL_SHIP_TO in df_in_item.columns else False
    #         m = m_item & m_ship

    #         # if COL_LOCATION in df_in_item.columns and len(loc_set) > 0:
    #         #     m &= df_in_item[COL_LOCATION].astype(str).isin(loc_set)
    #         # if COL_WEEK in df_in_item.columns and len(week_set) > 0:
    #         #     m &= df_in_item[COL_WEEK].astype(str).isin(week_set)

    #         logger.debug('기존 ShipTo-Item 별 Ratio(필터링): df_in_item')
    #         fn_log_dataframe(df_in_item.loc[m], 'df_step07_03_df_in_item_filtered', None)

    #     # 2) ShipTo-PG-Location-Week 레벨(df_in_shiptopg) : 관련 shipto+pg(+loc+week)만
    #     if not df_in_shiptopg.empty:
    #         m_ship = df_in_shiptopg[COL_SHIP_TO].astype(str).isin(shipto_set) if COL_SHIP_TO in df_in_shiptopg.columns else False
    #         m_pg   = df_in_shiptopg[COL_ITEM_STD1].astype(str).isin(pg_set) if COL_ITEM_STD1 in df_in_shiptopg.columns else False
    #         m = m_ship & m_pg

    #         if COL_LOCATION in df_in_shiptopg.columns and len(loc_set) > 0:
    #             m &= df_in_shiptopg[COL_LOCATION].astype(str).isin(loc_set)
    #         if COL_WEEK in df_in_shiptopg.columns and len(week_set) > 0:
    #             m &= df_in_shiptopg[COL_WEEK].astype(str).isin(week_set)

    #         logger.debug('기존 ShipTo-PG 별 Ratio(필터링): df_in_shiptopg')
    #         fn_log_dataframe(df_in_shiptopg.loc[m], 'df_step07_03_df_in_shiptopg_filtered', None)

    #     # 3) PG-Location-Week 레벨(df_in_pg) : 관련 pg(+loc+week)만
    #     if not df_in_pg.empty:
    #         m_pg = df_in_pg[COL_ITEM_STD1].astype(str).isin(pg_set) if COL_ITEM_STD1 in df_in_pg.columns else False
    #         m = m_pg
    #         if COL_LOCATION in df_in_pg.columns and len(loc_set) > 0:
    #             m &= df_in_pg[COL_LOCATION].astype(str).isin(loc_set)
    #         if COL_WEEK in df_in_pg.columns and len(week_set) > 0:
    #             m &= df_in_pg[COL_WEEK].astype(str).isin(week_set)

    #         logger.debug('PG 별 Ratio 집계본. input 23~30 입력 → PG(Item Std1).(필터링): df_in_pg')
    #         fn_log_dataframe(df_in_pg.loc[m], 'df_step07_03_df_in_pg_filtered', None)

    # 2) 신규/기존 판정 플래그 계산 (0-1, 0-2) --------------------------------
    # 0-1) exists_item_in_item : df_in_item 에 Item 이 존재하는지 (Item 단위)
    if not df_in_item.empty and COL_ITEM in df_in_item.columns:
        items_existing = set(df_in_item[COL_ITEM].dropna().astype(str).unique())
        base["__exists_item_in_item"] = base[COL_ITEM].astype(str).isin(items_existing)
    else:
        base["__exists_item_in_item"] = False

    # 0-2) exists_shipto_in_item : df_in_item 에 (ShipTo, Item) 조합이 존재하는지
    if not df_in_item.empty and {COL_SHIP_TO, COL_ITEM}.issubset(df_in_item.columns):
        exist_pairs_df = df_in_item[[COL_SHIP_TO, COL_ITEM]].drop_duplicates()
        pair_set = set(
            zip(
                exist_pairs_df[COL_SHIP_TO].astype(str),
                exist_pairs_df[COL_ITEM].astype(str),
            )
        )
        base["__exists_shipto_in_item"] = [
            (s, i) in pair_set
            for s, i in zip(base[COL_SHIP_TO].astype(str), base[COL_ITEM].astype(str))
        ]
    else:
        base["__exists_shipto_in_item"] = False

    # 3) 케이스 3: exists_shipto_in_item == True → Data 생성하지 않음(삭제) -----
    base = base[~base["__exists_shipto_in_item"]].copy()

    # 4) 측정치 컬럼 초기화 (모두 NaN) -----------------------------------------
    for c in ratio_cols:
        base[c] = np.nan

    # 5) 규칙(1) 신규 Item (exists_item_in_item == False)
    #    → df_in_shiptopg (ShipTo + ItemStd1 + Location + Week) 로 채움 -------    
    if not df_in_shiptopg.empty:
        key_1 = [COL_SHIP_TO, COL_ITEM_STD1, COL_LOCATION, COL_WEEK]
        cols_1 = key_1 + ratio_cols

        # 매핑 DF: ShipTo + PG(ItemStd1) + Location + Week
        r1 = (
            df_in_shiptopg[cols_1]
            .drop_duplicates()
            .rename(columns={c: f"__r1_{c}" for c in ratio_cols})
        )

        base = base.merge(r1, on=key_1, how="left")

        for c in ratio_cols:
            src = f"__r1_{c}"
            if src not in base.columns:
                continue
            # 케이스 1: 신규 Item (exists_item_in_item == False) 만 채움
            cond_case1 = base[c].isna() & (~base["__exists_item_in_item"])
            base[c] = np.where(cond_case1, base[src], base[c])
            base.drop(columns=[src], inplace=True)

    # 6) 규칙(2) 기존 Item + 신규 ShipTo
    #    (exists_item_in_item == True AND exists_shipto_in_item == False)
    #    → df_in_pg (ItemStd1 + Location + Week) 로 채움 -----------------------
    if not df_in_pg.empty:
        key_2 = [COL_ITEM_STD1, COL_LOCATION, COL_WEEK]
        cols_2 = key_2 + ratio_cols

        r2 = (
            df_in_pg[cols_2]
            .drop_duplicates()
            .rename(columns={c: f"__r2_{c}" for c in ratio_cols})
        )

        base = base.merge(r2, on=key_2, how="left")

        for c in ratio_cols:
            src = f"__r2_{c}"
            if src not in base.columns:
                continue
            # 여기 시점에서 base 에는 exists_shipto_in_item == False 인 row만 남아 있음
            # → 케이스 2는 "기존 Item" 인 행들만 대상
            cond_case2 = base[c].isna() & base["__exists_item_in_item"]
            base[c] = np.where(cond_case2, base[src], base[c])
            base.drop(columns=[src], inplace=True)

    # 7) 작업용 플래그 컬럼 제거 -----------------------------------------------
    base.drop(columns=["__exists_item_in_item", "__exists_shipto_in_item"], inplace=True)

    # 8) 출력 컬럼 정리 + Version 주입 -----------------------------------------
    out_cols = [COL_VERSION, COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_WEEK] + ratio_cols

    if COL_VERSION not in base.columns:
        base.insert(0, COL_VERSION, out_version)
    else:
        base[COL_VERSION] = out_version
    ...
    # 9) dtype 정리 (카테고리 / float32) ---------------------------------------
    for cat_col in [COL_VERSION, COL_SHIP_TO, COL_ITEM, COL_LOCATION, COL_WEEK]:
        if cat_col in base.columns:
            base[cat_col] = base[cat_col].astype("category")

    for m in ratio_cols:
        base[m] = pd.to_numeric(base[m], errors="coerce").astype("float32")

    # (필요하면 라운딩 로직도 다시 활성화 가능)
    # if round_digits is not None and round_digits >= 0:
    #     for c in ratio_cols:
    #         base[c] = base[c].round(round_digits)

    return base

# ──────────────────────────────────────────────────────────────────────────────
# 7-1 ~ 7-8 래퍼: RATIO_GROUPS 메타만 바꿔서 같은 로직 호출
# ──────────────────────────────────────────────────────────────────────────────
@_decoration_
def fn_step07_build_by_group(
    group_key   : str,
    df_targets  : pd.DataFrame,
    df_time_w   : pd.DataFrame,
    df_item_mst : pd.DataFrame,
    ...
    meta = RATIO_GROUPS[group_key]
    return _fn_step07_build_ratio_common(
        group_key      = group_key,
        df_targets     = df_targets,
        df_time_w      = df_time_w,
        df_item_mst    = df_item_mst,
        df_in_item     = dict_dfs.get(meta['df_in_item'], pd.DataFrame()),
        df_in_shiptopg = dict_dfs.get(meta['df_in'],      pd.DataFrame()),
        df_in_pg       = dict_dfs.get(meta['df_pg'],      pd.DataFrame()),
        ratio_cols     = meta['cols'],
        out_version    = out_version
    )
...
if __name__ == '__main__':
    ...
    try:
        ...
        if is_local:
            Version = 'CWV_DP'
            # 파라메터추가 2025.11.07
            salesItemLocation = '400001:RF29BB8600QLAA^400003:RF29BB8600QLAA'
            measureLv = 'ap2'
            # ----------------------------------------------------
            # parse_args 대체
            ...
            str_input_dir = f'Input/{input_folder_name}/PYSalesProductASNDeltaeStore'
            # ------
        ...
        for in_df in input_dataframes:
            # 로그출력
            # if in_df in ['df_in_Sell_In_Final_GI_Ratio_Item']:
            #     fn_log_dataframe(input_dataframes[in_df], in_df,None)
            # else:
        ...
        ################################################################################################################
        # Step 1-7) 모두 빈 경우 종료 플래그 (eStore: Flooring 제외)
        ################################################################################################################
        all_empty_step01 = (
        ...
        if all_empty_step01:
            ...
            if no_dummy_all:
                ...
                raise Exception('Step 1-2,Step 1-4 is empty.')  


        # ======================================================
        # Step 02: Assortment 값 생성  [eStore Main 호출부]
        #   - B2C와 동일하되 Flooring(2-3) 호출 없음
        # ======================================================
        ################################################################################################################
        ...
        # (eStore) Step 2-3 Flooring Assortment는 스펙상 미사용 → 호출/출력 생략
        #   B2C: fn_step02_03_build_assortment_from_flooring_dummy(...) 호출 및 Output_Flooring_Assortment 매핑
        #   eStore: 없음
        ################################################################################################################
        # Step 3 — FCST 값 생성 (상수명 정합 반영 버전)
        ################################################################################################################
        ...
        df_step05_02_sin_sr_ap2 = fn_step05_02_build_sin_sr_ap2(
            df_step03_06_sout_fcst_ap2,                                # Step 3-1-2 결과
            input_dataframes.get(DF_IN_ITEM_MST, pd.DataFrame()),
            input_dataframes.get(DF_IN_SDD, pd.DataFrame()),
        ...
        # Step 7-0) 대상 선정
        ################################################################################################################
        dict_log = {'p_step_no': 70, 'p_step_desc': 'Step 7-0) eStore 대상(ShipTo*Item*Location) 선정', 'p_df_name': None}
        df_step07_0_targets = fn_step07_0_select_targets(
            df_step01_01_sin_pick,   # Step 1-1 결과
            df_step01_03_sout_pick,  # Step 1-3 결과
            **dict_log
        )
        fn_log_dataframe(df_step07_0_targets, 'df_step07_0_targets')

        ################################################################################################################
        # Step 7-00) PG 집계본 생성 (23~30 → ItemStd1+Location+Week 평균, ShipTo 제거)
        ################################################################################################################
        dict_log = {'p_step_no': 700, 'p_step_desc': 'Step 7-00) PG(ItemStd1) 집계본 생성', 'p_df_name': None}
        _ = fn_step07_00_build_pg_ratio_tables(input_dataframes, **dict_log)
        # (생성 결과는 input_dataframes[DF_PG_…] 키들에 저장됨)
        for in_df in _:
            # 로그출력
            fn_log_dataframe(_[in_df], f'df_step07_00_{in_df}')

        ################################################################################################################
        # Step 7-1 ~ 7-8) 같은 로직으로 실행
        ################################################################################################################
        # 7-1
        dict_log = {'p_step_no': 71, 'p_step_desc': 'Step 7-1) S/In User GI Ratio', 'p_df_name': None}
        df_output_Sell_In_User_GI_Ratio = fn_step07_build_by_group(
            'USER_GI',
            df_step07_0_targets,
        ...
        fn_log_dataframe(df_output_Sell_In_User_GI_Ratio, f'df_step07_01_{DF_OUT_SIN_USER_GI_RATIO}',int_p_row_num=200)

        # 7-2
        dict_log = {'p_step_no': 72, 'p_step_desc': 'Step 7-2) S/In Issue GI Ratio', 'p_df_name': None}
        df_output_Sell_In_Issue_GI_Ratio = fn_step07_build_by_group(
            'ISSUE_GI',
            df_step07_0_targets,
            input_dataframes[DF_IN_TIME_W],
            input_dataframes.get(DF_IN_ITEM_MST, pd.DataFrame()),
        ...
        fn_log_dataframe(df_output_Sell_In_Issue_GI_Ratio, f'df_step07_02_{DF_OUT_SIN_ISSUE_GI_RATIO}',int_p_row_num=200)

        # 7-3
        dict_log = {'p_step_no': 73, 'p_step_desc': 'Step 7-3) S/In Final GI Ratio', 'p_df_name': None}
        df_output_Sell_In_Final_GI_Ratio = fn_step07_build_by_group(
            'FINAL_GI',
            df_step07_0_targets,
            input_dataframes[DF_IN_TIME_W],
            input_dataframes.get(DF_IN_ITEM_MST, pd.DataFrame()),
        ...
        fn_log_dataframe(df_output_Sell_In_Final_GI_Ratio, f'df_step07_03_{DF_OUT_SIN_FINAL_GI_RATIO}',int_p_row_num=200)

        # 7-4
        dict_log = {'p_step_no': 74, 'p_step_desc': 'Step 7-4) S/In BestFit GI Ratio', 'p_df_name': None}
        df_output_Sell_In_BestFit_GI_Ratio = fn_step07_build_by_group(
            'BESTFIT_GI',
            df_step07_0_targets,
            input_dataframes[DF_IN_TIME_W],
            input_dataframes.get(DF_IN_ITEM_MST, pd.DataFrame()),
        ...
        fn_log_dataframe(df_output_Sell_In_BestFit_GI_Ratio, f'df_step07_04_{DF_OUT_SIN_BESTFIT_GI_RATIO}',int_p_row_num=200)

        # 7-5
        dict_log = {'p_step_no': 75, 'p_step_desc': 'Step 7-5) S/In User Item GI Ratio', 'p_df_name': None}
        df_output_Sell_In_User_Item_GI_Ratio = fn_step07_build_by_group(
            'USER_ITEM_GI',
            df_step07_0_targets,
            input_dataframes[DF_IN_TIME_W],
            input_dataframes.get(DF_IN_ITEM_MST, pd.DataFrame()),
        ...
        fn_log_dataframe(df_output_Sell_In_User_Item_GI_Ratio, f'df_step07_05_{DF_OUT_SIN_USER_ITEM_GI_RATIO}',int_p_row_num=200)

        # 7-6
        dict_log = {'p_step_no': 76, 'p_step_desc': 'Step 7-6) S/In Issue Item GI Ratio', 'p_df_name': None}
        df_output_Sell_In_Issue_Item_GI_Ratio = fn_step07_build_by_group(
            'ISSUE_ITEM_GI',
            df_step07_0_targets,
            input_dataframes[DF_IN_TIME_W],
            input_dataframes.get(DF_IN_ITEM_MST, pd.DataFrame()),
        ...
        fn_log_dataframe(df_output_Sell_In_Issue_Item_GI_Ratio, f'df_step07_06_{DF_OUT_SIN_ISSUE_ITEM_GI_RATIO}',int_p_row_num=200)

        # 7-7
        dict_log = {'p_step_no': 77, 'p_step_desc': 'Step 7-7) S/In User Modify GI Ratio', 'p_df_name': None}
        df_output_Sell_In_User_Modify_GI_Ratio = fn_step07_build_by_group(
            'USER_MODIFY_GI',
            df_step07_0_targets,
            input_dataframes[DF_IN_TIME_W],
            input_dataframes.get(DF_IN_ITEM_MST, pd.DataFrame()),
        ...
        fn_log_dataframe(df_output_Sell_In_User_Modify_GI_Ratio, f'df_step07_07_{DF_OUT_SIN_USER_MODIFY_GI_RATIO}',int_p_row_num=200)

        # 7-8
        dict_log = {'p_step_no': 78, 'p_step_desc': 'Step 7-8) S/In Issue Modify GI Ratio', 'p_df_name': None}
        df_output_Sell_In_Issue_Modify_GI_Ratio = fn_step07_build_by_group(
            'ISSUE_MODIFY_GI',
            df_step07_0_targets,
            input_dataframes[DF_IN_TIME_W],
            input_dataframes.get(DF_IN_ITEM_MST, pd.DataFrame()),
        ...
        fn_log_dataframe(df_output_Sell_In_Issue_Modify_GI_Ratio, f'df_step07_08_{DF_OUT_SIN_ISSUE_MODIFY_GI_RATIO}',int_p_row_num=200)

        # (o9 바인딩)
        Output_Sell_In_User_GI_Ratio           = df_output_Sell_In_User_GI_Ratio
        Output_Sell_In_Issue_GI_Ratio          = df_output_Sell_In_Issue_GI_Ratio
        Output_Sell_In_Final_GI_Ratio          = df_output_Sell_In_Final_GI_Ratio
        Output_Sell_In_BestFit_GI_Ratio        = df_output_Sell_In_BestFit_GI_Ratio
        Output_Sell_In_User_Item_GI_Ratio      = df_output_Sell_In_User_Item_GI_Ratio
        Output_Sell_In_Issue_Item_GI_Ratio     = df_output_Sell_In_Issue_Item_GI_Ratio
        Output_Sell_In_User_Modify_GI_Ratio    = df_output_Sell_In_User_Modify_GI_Ratio
        Output_Sell_In_Issue_Modify_GI_Ratio   = df_output_Sell_In_Issue_Modify_GI_Ratio
